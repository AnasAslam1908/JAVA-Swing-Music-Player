...
public class delSong extends JFrame {
    JLabel headingLabel;
    ...
    delSong(String name){
       ...
       // nameReader();
        ...
        headingLabel.setText("Select Musics to Delete ");
        ...
        while (currButton!=null){
            ...
            currButton.data.setIcon(new ImageIcon("musicButton.png"));
        ...
        while (currButton!=null){
            ...
            currButton.data.addActionListener(e -> {
               GetSong= delNode(finalCurrButton.data.getText());
                deletingSong(name);
                this.dispose();
                new delSong(name);
            //    addSongs(name);
        ...
        ImageIcon mainIcon=new ImageIcon("mainIcon2.jpg");
    ...
    private void deletingSong(String name){
        queueNode<String>curr=new queueNode<>();
        curr=GetSong.head;
        try {
    ...
    public queueLinkedList<String> delNode(String del){
        queueLinkedList<String>temp=new queueLinkedList<>();
        queueNode<String> curr=GetSong.head;
        while (curr!=null){
            if(curr.data!=del){
                temp.add(curr.data);
            }
