     ...
     //   topPane.setBounds(0,0,520,75);
       ...
       // panel.setLayout(new GridLayout(3,3,10,10));
        ...
        while (currButton!=null){
            ...
            currButton.data.setIcon(new ImageIcon("collectionlogo3.png"));
...
//            currButton.data.setVerticalTextPosition(JButton.BOTTOM);
        ...
        pause=new JButton();
        pause.setIcon(new ImageIcon("pauseC.png"));
        ...
        forward=new JButton();
        forward.setIcon(new ImageIcon("fastC.png"));
        ...
        backward.setIcon(new ImageIcon("fastCR.png"));
       ...
       // textField.setBounds(0,0,100,50);
        textField.setIcon(new ImageIcon("collectionlogo4.png"));
    ...
    private void pauseMusic() {
        ...
        if (clip != null && clip.isRunning()) {
            clip.stop();
            isPaused=true;
            pause.setIcon(new ImageIcon("playC.png"));;
