...
public class PlayList extends JFrame {
    ...
    PlayList(String name,String songName){
      ...
      //  this.add(panelMain,BorderLayout.NORTH);
        ...
        pauseButton.setIcon(new ImageIcon("pauseButton.png"));
        ...
        previousButton.setIcon(new ImageIcon("prevButton.png"));
        ...
        loopButton.setIcon(new ImageIcon("loopButton.png"));
        ...
        forwardButton.setIcon(new ImageIcon("forButton.png"));
        ...
        backwardButton.setIcon(new ImageIcon("backButton.png"));
    ...
    private void pauseMusic() {
        ...
        if (clip != null && clip.isRunning()) {
            clip.stop();
            isPaused=true;
            pauseButton.setIcon(new ImageIcon("playButton.png"));
